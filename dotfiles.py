...
class DotfilesManager:
    ...
    def _analyze_dotfiles_status(self):
    ...
    def _handle_conflicts_interactively(self, conflicts, target):
        ...
        print(f"  (1) Backup and replace (recommended)")
        print(f"  (2) Adopt existing files into repository")
        print(f"  (3) Show conflicts and exit")
        print(f"  (q) Cancel")
            ...
            if conflict_path.exists():
                ...
                if conflict_path.is_file():
                    try:
                        ...
                        print(f"    Could not read file stats")
    ...
    def cmd_interactive(self):
        ...
        print(f"  (1) Apply all dotfiles (handle conflicts)")
        print(f"  (2) Fix conflicts only")
        print(f"  (3) Fix broken symlinks")
        print(f"  (4) Re-stow all dotfiles")
        print(f"  (q) Quit")
